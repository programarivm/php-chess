...
use Chess\Variant\Classical\FEN\StrToBoardFactory;

class StrToBoardFactoryTest extends AbstractUnitTestCase
{
    /**
     * @test
     */
    ...
    public function foo_bar_throws_exception()
    {
        ...
        StrToBoardFactory::create('foo bar');
    }
    ...
    public function no_kings_throws_exception()
    {
        ...
        $board = StrToBoardFactory::create('8/8/5r1R/8/7p/8/8/8 b - - 0 1');
    }
    ...
    public function eT_throws_exception()
    {
        ...
        $board = StrToBoardFactory::create('7K/8/5e1T/8/7k/8/8/8 b - - 0 1');
    }
    ...
    public function x_throws_exception()
    {
        ...
        $board = StrToBoardFactory::create('7x/8/5k1K/8/7p/8/8/8 b - - 0 1');
    }
    ...
    public function y_throws_exception()
    {
        ...
        $board = StrToBoardFactory::create('7y/8/5k1K/8/7p/8/8/8 b - - 0 1');
    }
    ...
    public function nine_throws_exception()
    {
        ...
        $board = StrToBoardFactory::create('7k/9/8/8/8/8/2K5/r7 w - - 0 1');
    }
    ...
    public function e4()
    {
        $board = StrToBoardFactory::create('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1');
    ...
    {
        $board = StrToBoardFactory::create('rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2');
    ...
    public function A59()
    {
        $board = StrToBoardFactory::create('rn1qkb1r/4pp1p/3p1np1/2pP4/4P3/2N3P1/PP3P1P/R1BQ1KNR b kq - 0 9');
    ...
    {
        $board = StrToBoardFactory::create('r1b1kbnr/1pp2ppp/p1p5/8/3NP3/8/PPP2PPP/RNB1K2R b KQkq - 0 7');
    ...
    {
        $board = StrToBoardFactory::create('r1bqk1nr/pp2ppbp/2np2p1/2p5/4P3/2NP2P1/PPP2PBP/R1BQK1NR w KQkq - 0 6');
    ...
    {
        $board = StrToBoardFactory::create('rnbqkbnr/pp1pp1pp/8/2p1Pp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6 0 3');
    ...
    {
        $board = StrToBoardFactory::create('1rbq1rk1/p1b1nppp/1p2p3/8/1B1pN3/P2B4/1P3PPP/2RQ1R1K w - - bm Nf6+');
    ...
    {
        $board = StrToBoardFactory::create('8/5k2/8/8/2K1p3/3r4/8/8 w - - 0 1');
    ...
    {
        $board = StrToBoardFactory::create('8/5k2/8/8/2K5/3rp3/8/8 w - - 0 1');
    ...
    {
        $board = StrToBoardFactory::create('7k/8/8/8/8/8/2K5/r7 w - - 0 1');
    ...
    {
        $board = StrToBoardFactory::create('8/8/R7/8/4Q3/rk3K2/8/8 w - -');
    ...
    {
        $board = StrToBoardFactory::create('r1Q2rk1/p2p1pp1/1ppq1n1p/4p3/1PP1P3/P4N2/1B3PPP/R4RK1 b - -');
    ...
    {
        $board = StrToBoardFactory::create('k1N3N1/8/2K5/8/8/8/8/8 w - - 0 1');
    ...
    {
        $board = StrToBoardFactory::create('k1N3N1/4p3/2K5/8/8/8/8/8 w - - 0 1');
    ...
    {
        $board = StrToBoardFactory::create('4R3/k7/3K4/8/4q3/8/8/4R3 w - - 0 1');
    ...
    {
        $board = StrToBoardFactory::create('rnbqkb1r/pppppp1p/5np1/8/2PP4/2N5/PP2PPPP/R1BQKBNR b KQkq -');
    ...
    {
        $board = StrToBoardFactory::create('rnbqk2r/pppp1ppp/4pn2/8/1bPP4/2N1P3/PP3PPP/R1BQKBNR b KQkq -');
    ...
    {
        $board = StrToBoardFactory::create('rnbqkbnr/ppp2ppp/8/3pp3/5P2/6PN/PPPPP2P/RNBQKB1R b KQkq f3');
    ...
    {
        $board = StrToBoardFactory::create('R1bq1rk1/1p6/2pp2np/4pp2/1PPnP1pP/2NP4/3BQPBP/6K1 w - -');
    ...
    {
        $board = StrToBoardFactory::create('1rb1r1k1/1pq1bppp/p2p1n2/4p3/P1nNPP2/2N2B2/1PP2QPP/R1B2R1K w - -');
    ...
    {
        $board = StrToBoardFactory::create('r5k1/2rb2p1/3p3p/q2Pbp2/P1P1p3/1QN3PP/R4P2/2R2BK1 w - -');
