...
class FlightSquareEvalTest extends AbstractUnitTestCase
{
    ...
    public function Rh2()
    {
        ...
        $expectedExplanation = [
            "Black's king has many more safe squares to move to than its counterpart, if threatened.",
        ];
    ...
    public function Qa5()
    {
        ...
        $expectedExplanation = [
            "Black's king has a slightly higher number of safe squares to move to than its counterpart, if threatened.",
        ];
